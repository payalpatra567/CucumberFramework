...
public class Landingpage {
	...
	{
		return driver.findElement(h.Footerdriver);
	}
	public WebElement getColumndriver()
	{
		return driver.findElement(h.columndriver);
	}
	public WebElement getAdv()
	{
		return driver.findElement(h.Adv);
	}
}
